...
public interface StatusCodeConstants {
    ...
    StatusCode ATTRIBUTE_SCOPE_NOT_ALLOW_ADD = StatusCode.build("ATTRIBUTE_SCOPE_NOT_ALLOW_ADD", "属性：%s，范围：%s，该范围属性不支持设置值.");
    StatusCode ATTRIBUTE_SCOPE_NOT_ALLOW_UPDATE = StatusCode.build("ATTRIBUTE_SCOPE_NOT_ALLOW_UPDATE", "属性：%s，范围：%s，该范围属性不支持更新.");
    StatusCode ATTRIBUTE_SCOPE_NOT_ALLOW_EXTRACT = StatusCode.build("ATTRIBUTE_SCOPE_NOT_ALLOW_EXTRACT", "属性：%s，范围：%s，该范围属性不支持提取.");
    StatusCode DEVICE_ATTRIBUTE_VALUE_INVALID = StatusCode.build("DEVICE_ATTRIBUTE_VALUE_INVALID", "无效的属性值，请检查与数据类型是否匹配.");
    ...
    StatusCode KNOWN_ATTRIBUTES_NOT_UPDATE_DATA_TYPE = StatusCode.build("KNOWN_ATTRIBUTES_NOT_UPDATE_DATA_TYPE", "已知属性不支持修改数据类型.");
