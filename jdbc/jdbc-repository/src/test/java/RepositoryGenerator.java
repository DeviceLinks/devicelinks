...
public class RepositoryGenerator {
    ...
    static String generateRepository(Class<?> entityClass) {
        ...
        buffer.append("package cn.devicelinks.jdbc.repositorys;").append(lineSeparator);
        buffer.append(lineSeparator);
        buffer.append("import " + entityClass.getName() + ";").append(lineSeparator);
        buffer.append("import cn.devicelinks.jdbc.core.Repository;").append(lineSeparator);
        buffer.append(lineSeparator);
        buffer.append("/**" + lineSeparator +
    ...
    static String generateJdbcRepository(Class<?> entityClass) {
        ...
        buffer.append("import " + entityClass.getName() + ";").append(lineSeparator);
        buffer.append("import cn.devicelinks.jdbc.core.JdbcRepository;").append(lineSeparator);
        buffer.append("import org.springframework.jdbc.core.JdbcOperations;").append(lineSeparator);
        buffer.append(lineSeparator);
        buffer.append("import static cn.devicelinks.jdbc.tables.T" + className + "." + tableNameUpper + ";").append(lineSeparator);
        buffer.append(lineSeparator);
        buffer.append("/**" + lineSeparator +
