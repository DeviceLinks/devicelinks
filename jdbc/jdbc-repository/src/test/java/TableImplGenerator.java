...
public class TableImplGenerator {
    ...
    static String generate(Class<?> entityClass, Map<String, String> columnMapperMap) {
        ...
        buffer.append("package cn.devicelinks.jdbc.tables;").append(lineSeparator);
        buffer.append(lineSeparator);
        buffer.append("import cn.devicelinks.framework.common.DeviceLinksVersion;").append(lineSeparator);
        buffer.append("import cn.devicelinks.jdbc.core.definition.Column;").append(lineSeparator);
        buffer.append("import cn.devicelinks.jdbc.core.definition.TableImpl;").append(lineSeparator);
        buffer.append("import cn.devicelinks.jdbc.ColumnValueMappers;").append(lineSeparator);
