...
import cn.devicelinks.common.NotificationType;
import cn.devicelinks.component.jackson.utils.JacksonUtils;
import cn.devicelinks.entity.*;
import cn.devicelinks.jdbc.core.mapper.value.*;
...
public interface ColumnValueMappers extends BasicColumnValueMapper {
    ...
    JSONObjectValueMapper DYNAMIC_REGISTRATION_ADDITION = new JSONObjectValueMapper(DynamicRegistrationAddition.class);
    JSONObjectValueMapper DEVICE_ENCRYPTED_SECRET_ADDITION = new JSONObjectValueMapper(DeviceEncryptedSecretAddition.class);
