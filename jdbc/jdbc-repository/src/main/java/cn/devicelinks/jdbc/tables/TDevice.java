...
public class TDevice extends TableImpl {
    ...
    public final Column DEVICE_NAME = Column.withName("device_name").build();
    ...
    public List<Column> getColumns() {
        return List.of(ID, DEPARTMENT_ID, PRODUCT_ID, PROFILE_ID, DEVICE_TYPE, DEVICE_NAME, NOTE_NAME, STATUS, IP_ADDRESS, TAGS, ACTIVATION_TIME, LAST_ONLINE_TIME, LAST_REPORT_TIME, ENABLED, DELETED, ADDITION, CREATE_BY, CREATE_TIME, MARK);
    }
}