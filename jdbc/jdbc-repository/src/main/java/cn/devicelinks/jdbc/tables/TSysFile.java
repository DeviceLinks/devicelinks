...
import cn.devicelinks.entity.SysFile;
...
public class TSysFile extends TableImpl {
	...
	public final Column CHECKSUM = Column.withName("checksum").build();
    ...
    public List<Column> getColumns() {
        return List.of(ID, NAME, PATH, SIZE, SIGN_ALGORITHM, SIGN_WITH_KEY, CHECKSUM, DELETED, CREATE_BY, CREATE_TIME);
    }
}