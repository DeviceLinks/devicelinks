...
public class TOta extends TableImpl {
    ...
    public final Column VERSION_BEFORE = Column.withName("version_before").build();
    ...
    public List<Column> getColumns() {
        return List.of(ID, PRODUCT_ID, MODULE_ID, TYPE, VERSION_BEFORE, VERSION, SIGN_ALGORITHM, SIGN_WITH_KEY, VERIFY, UPGRADE_ITEM, ADDITION, ENABLED, DELETED, CREATE_TIME, CREATE_BY, MARK);
    }
}
