...
/**
 * The {@link SysUserSession} Table Impl
 *
 * @author 恒宇少年
 * @since 1.0
 */
public class TSysUserSession extends TableImpl {
    ...
    public List<Column> getColumns() {
        return List.of(ID, USER_ID, USERNAME, TOKEN_VALUE, IP_ADDRESS, PLATFORM_TYPE, STATUS, ISSUED_TIME, EXPIRES_TIME, LOGOUT_TIME, LAST_ACTIVE_TIME);
    }
}
