...
public class TSysUserSession extends TableImpl {
    ...
    public final Column STATUS = Column.withName("status").typeMapper(ColumnValueMappers.SESSION_STATUS).defaultValue(() -> SessionStatus.Normal).build();
    public final Column ISSUED_TIME = Column.withName("issued_time").localDateTimeValue().defaultValue(LocalDateTime::now).build();
