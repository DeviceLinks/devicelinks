...
import cn.devicelinks.api.support.request.AddDeviceDesiredAttributeRequest;
import cn.devicelinks.api.support.request.ExtractUnknownDesiredAttributeRequest;
import cn.devicelinks.api.support.request.UpdateDeviceDesiredAttributeRequest;
...
public class DeviceAttributeDesiredController {
    ...
    public ApiResponse<DeviceAttributeDesired> addDesiredAttribute(@PathVariable("deviceId") String deviceId,
        ...
        return ApiResponse.success(this.desiredAttributeService.addDesiredAttribute(device, moduleId, request));
    }
    ...
    public ApiResponse<Attribute> extractUnknownDesiredAttribute(@PathVariable("desiredAttributeId") String desiredAttributeId,
        ...
        return ApiResponse.success(this.desiredAttributeService.extractUnknownAttribute(desiredAttributeId, request, userAuthorizedAddition));
    }
