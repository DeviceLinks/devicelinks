...
import cn.devicelinks.api.support.request.AddProductRequest;
import cn.devicelinks.api.support.request.UpdateProductRequest;
...
public class ProductController {
    ...
    public ApiResponse<Product> addProduct(@Valid @RequestBody AddProductRequest request) throws ApiException {
        ...
        Product product = new Product()
                ...
                .setAuthenticationMethod(DeviceCredentialsType.valueOf(request.getAuthenticationMethod()))
                .setStatus(ProductStatus.Development)
                .setCreateBy(currentUserId)
                .setDescription(request.getDescription());
        // @formatter:on
        return ApiResponse.success(this.productService.addProduct(product,authorizedAddition));
    }
