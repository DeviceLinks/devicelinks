...
package cn.devicelinks.console.component.jackson.deserializer;
...
/**
 * {@link DeviceLinksUserDetails} Jackson反序列化定义
 *
 * @author 恒宇少年
 * @since 1.0
 */
public class UserDetailsDeserializer extends JsonDeserializer<DeviceLinksUserDetails> {
    @Override
