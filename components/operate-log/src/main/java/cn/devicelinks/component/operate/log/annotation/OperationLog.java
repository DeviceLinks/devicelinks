 ...
 * - "#before": 前置数据；在目标方法之前执行，支持SpEL表达式。依据{@link #object()}
 * - "#after": 后置数据；在目标方法之后执行，支持SpEL表达式。依据{@link #object()}
...
public @interface OperationLog {
     ...
     *
     * @return 获取操作目标对象详情的SpEL表达式，一般解析后返回对象实例
     */
     ...
     * 当前操作的活动数据
     * <p>
     * 会将解析后的值解析成JSON字符串存储到操作日志“活动数据”列中
     * 目标方法执行成功或失败都会执行数据解析
     * <p>
